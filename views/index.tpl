...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Jostler | Financical Mate</title>
    <meta name="description" content="Awesome financical mate for everyone!" />
    <meta name="keywords" content="money financy, css3, one page, animations, agency, portfolio, web design" />
    <meta name="author" content="Evgeny Lyzov" />
    <!-- Bootstrap -->
  ...
  <body>
        ...
        <div class="container">
          <div class="row nav-wrapper">
            <div class="col-md-6 col-sm-6 col-xs-6 text-left">
              <a href="#"><img src="/static/img/logo-white.png" alt="Jostler Logo"></a>
            </div>
          ...
          <div class="row hero-content">
            <div class="col-md-12">
              <h1 class="animated fadeInDown">Financical Mate For Everyone</h1>
              <a href="http://tympanus.net/codrops/?p=22554" class="use-btn animated fadeInUp">Sign In</a> <a href="#about" class="learn-btn animated fadeInUp">Learn more <i class="fa fa-arrow-down"></i></a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="col-md-6 nopadding features-intro-img">
            <div class="features-bg">
              ...
              <div class="features-img wp1">
                <img src="/static/img/html5-logo.png" alt="HTML5 Logo">
              </div>
            </div>
          </div>
          ...
          <div class="row">
                ...
                <div class="device-content">
                  <div class="showcase-slider">
                    <ul class="slides" id="showcaseSlider">
                      <li>
                        <img src="/static/img/screen1.jpg" alt="Device Content Image">
                      </li>
                      <li>
                        <img src="/static/img/screen2.jpg" alt="Device Content Image">
                      </li>
                      <li>
                        <img src="/static/img/screen3.jpg" alt="Device Content Image">
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              ...
              <blockquote class="team-quote">
                <div class="avatar"><img src="/static/img/avatar.png" alt="User Avatar"></div>
                ...
                <div class="logo-quote">
                  <a href="http://tympanus.net/codrops/"><img src="/static/img/codrops-logo.png" alt="Codrops Logo"></a>
                </div>
              </blockquote>
      ...
      <div class="container-fluid">
        <div class="row">
          <ul class="grid">
            <li>
              <figure>
                <img src="/static/img/01-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/01.jpg" class="single_image">
            ...
            <li>
              <figure>
                <img src="/static/img/02-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/02.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
            ...
            <li>
              <figure>
                <img src="/static/img/03-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/03.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
            ...
            <li>
              <figure>
                <img src="/static/img/04-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/04.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
                    <p>Absolutely Free</p>
                  </a>
                </div>
        ...
        <div class="row">
          <ul class="grid">
            <li>
              <figure>
                <img src="/static/img/05-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/05.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
            ...
            <li>
              <figure>
                <img src="/static/img/06-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/06.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
            ...
            <li>
              <figure>
                <img src="/static/img/07-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/07.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
                    <p>Made with Love</p>
                  </a>
                </div>
            ...
            <li>
              <figure>
                <img src="/static/img/08-screenshot.jpg" alt="Screenshot 01">
                <figcaption>
                <div class="caption-content">
                  <a href="/static/img/large/08.jpg" class="single_image">
                    <i class="fa fa-search"></i><br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5">
            ...
            <img src="/static/img/logo-blue.png" alt="Footer Logo Blue">
            </h1>
            <p>© Jostler 2015 - <a href="http://tympanus.net/codrops/licensing/">Licence</a> - Designed &amp; Developed by <a href="http://www.peterfinlan.com/">Evgeny Lyzov</a></p>
          </div>
          <div class="col-md-7">
            <ul class="footer-nav">
    ...
    <script src="/static/js/min/toucheffects-min.js"></script>
